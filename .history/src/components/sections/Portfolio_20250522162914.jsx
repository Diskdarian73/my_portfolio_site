          ...
          <Card className="overflow-hidden h-full flex flex-col transition-all duration-300 ease-in-out hover:shadow-2xl hover:border-primary dark:hover:border-deep-gold">
            <CardHeader className="p-0 relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center">
                <Button 
                  variant="secondary" 
                  className="mb-4 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 delay-100 bg-primary/80 hover:bg-primary text-primary-foreground dark:bg-deep-gold/80 dark:hover:bg-deep-gold dark:text-black"
