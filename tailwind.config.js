    ...
    module.exports = {
      ...
      theme: {
        ...
        extend: {
          ...
          backgroundImage: {
            'hero-gradient-dark': 'linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--secondary)) 100%)',
            'hero-gradient-light': 'linear-gradient(135deg, hsl(var(--primary) / 0.8) 0%, hsl(var(--secondary) / 0.8) 100%)',
          }
        },
      },
